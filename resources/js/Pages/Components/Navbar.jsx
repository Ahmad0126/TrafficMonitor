                ...
                <div className="main-header-logo">
                    ...
                    <div className="logo-header" data-background-color="dark">
                        <a href="index.html" className="logo">
                            <img src="public/assets/img/kaiadmin/logo_light.svg" alt="navbar brand" className="navbar-brand" height="20" />
                        </a>
                        ...
                        <ul className="navbar-nav topbar-nav ms-md-auto align-items-center">
                            ...
                            <li className="nav-item topbar-icon dropdown hidden-caret">
                                ...
                                <ul className="dropdown-menu messages-notif-box animated fadeIn"
                                    ...
                                    <li>
                                        <a className="see-all" href="#">See all messages<i
                                        ...
                                        <li>
                                            <div className="user-box">
                                                ...
                                                <div className="u-text">
                                                    ...
                                                    <a href="profile.html" className="btn btn-xs btn-secondary btn-sm">View
                                                        Profile</a>
                                                </div>
                                            </div>
                                        </li>
